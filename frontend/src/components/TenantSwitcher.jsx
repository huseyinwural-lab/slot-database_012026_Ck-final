...
const TenantSwitcher = () => {
  const { isOwner, tenantName } = useCapabilities();
  const [impersonating, setImpersonating] = useState('default');
  ...
  return (
    <div className="flex items-center gap-2 mr-4 border-r border-border pr-4">
        ...
        <Select value={impersonating} onValueChange={setImpersonating}>
