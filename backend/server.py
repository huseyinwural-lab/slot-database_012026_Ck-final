...
from app.routes import fraud_detection, email_notification, core, simulator, modules, crm, affiliates, support, risk, approvals, rg, cms, reports
...
app.include_router(reports.router) # New Reports Router
