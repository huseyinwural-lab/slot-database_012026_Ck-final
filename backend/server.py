...
from app.routes import fraud_detection, email_notification, core, simulator, modules, crm, affiliates, support, risk, approvals, rg, cms
...
app.include_router(cms.router) # New CMS Router
