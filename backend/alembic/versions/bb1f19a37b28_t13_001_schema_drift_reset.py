...
Revision ID: bb1f19a37b28
Revises: 4de54ad60828
Create Date: 2025-12-27 00:06:04.196715
...
def upgrade() -> None:
    ...
    op.drop_index('ix_bonusgrant_campaign_id', table_name='bonusgrant')
    op.drop_index('ix_bonusgrant_player_id', table_name='bonusgrant')
    op.drop_index('ix_bonusgrant_tenant_id', table_name='bonusgrant')
    op.drop_table('bonusgrant')
    op.drop_index('ix_table_game_tenant_id', table_name='table_game')
    op.drop_table('table_game')
    op.drop_index('ix_bonuscampaign_tenant_id', table_name='bonuscampaign')
    op.drop_table('bonuscampaign')
...
def downgrade() -> None:
    ...
    op.create_index('ix_bonuscampaign_tenant_id', 'bonuscampaign', ['tenant_id'], unique=False)
    ...
    op.create_table('bonusgrant',
    sa.Column('id', sa.VARCHAR(), nullable=False),
    sa.Column('tenant_id', sa.VARCHAR(), nullable=False),
    sa.Column('campaign_id', sa.VARCHAR(), nullable=False),
    sa.Column('player_id', sa.VARCHAR(), nullable=False),
    sa.Column('amount_granted', sa.FLOAT(), nullable=False),
    sa.Column('initial_balance', sa.FLOAT(), nullable=False),
    sa.Column('wagering_target', sa.FLOAT(), nullable=False),
    sa.Column('wagering_contributed', sa.FLOAT(), nullable=False),
    sa.Column('status', sa.VARCHAR(), nullable=False),
    sa.Column('granted_at', sa.DATETIME(), nullable=False),
    sa.Column('expires_at', sa.DATETIME(), nullable=True),
    sa.Column('completed_at', sa.DATETIME(), nullable=True),
    sa.Column('device_fingerprint', sa.VARCHAR(), nullable=True),
    sa.Column('ip_address', sa.VARCHAR(), nullable=True),
    sa.ForeignKeyConstraint(['campaign_id'], ['bonuscampaign.id'], ),
    sa.ForeignKeyConstraint(['player_id'], ['player.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_bonusgrant_tenant_id', 'bonusgrant', ['tenant_id'], unique=False)
    op.create_index('ix_bonusgrant_player_id', 'bonusgrant', ['player_id'], unique=False)
    op.create_index('ix_bonusgrant_campaign_id', 'bonusgrant', ['campaign_id'], unique=False)
