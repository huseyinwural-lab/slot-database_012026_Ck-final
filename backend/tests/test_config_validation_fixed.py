...
def test_prod_config_validation_success():
    ...
    with patch.dict("os.environ", {
        "ENV": "prod",
        "STRIPE_API_KEY": "sk_live_123",  # Must contain 'live' for prod
        "STRIPE_WEBHOOK_SECRET": "whsec_123",
        "ADYEN_API_KEY": "adyen_key",
        "ADYEN_MERCHANT_ACCOUNT": "merchant",
        "ADYEN_HMAC_KEY": "hmac",
        "KYC_MOCK_ENABLED": "false",  # Must be false for prod
        "AUDIT_EXPORT_SECRET": "strong_secret_not_default"  # Must be changed from default
    }):
        s = Settings()
...
def test_prod_config_validation_fail_adyen():
    ...
    with patch.dict("os.environ", {
        "ENV": "prod",
        "STRIPE_API_KEY": "sk_live_test",  # Contains 'live'
